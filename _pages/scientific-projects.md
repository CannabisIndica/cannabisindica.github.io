...
star challenges formation models”</span> (2025). [[Report](/files/scientific-projects/reproducing_stefansson.pdf)].

5. <span style="color: orange;">String Theory: Analysis of the Fermi-Pasta-Ulam-Tsingou (FPUT) Problem</span>. _Pythonic implementation of the original FPUT problem with 2D extension_ (2024). [[Presentation](/files/scientific-projects/fput.pptx)].

6. <span style="color: orange;">Getting the W: Substantiating the rate variable, W, introduced by Kawaguchi et al. to model F1-ATPase</span>. _Critisizing existing work in literature on the mechanical properties of ATPase_ (2023). [[Presentation](/files/scientific-projects/atpase.pptx)].
